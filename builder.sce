function builder_gw_cpp()
	...
	ilib_build('build_lib', ['callJulia','sci_call_julia'; 'initJulia', 'sci_init_julia'; 'evalJulia', 'sci_eval_julia'; 'exitJulia', 'sci_exit_julia'], files, [julialibpath + filesep() + 'libjulia'], [], ldflag, include);
